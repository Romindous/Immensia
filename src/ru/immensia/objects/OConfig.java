...
public class OConfig {
    ...
    public void set(String path, Object value, String comment) {
        if (!this.config.contains(path)) {
            this.config.set(Main.manager.getPluginName() + "_COMMENT_" + comments, " " + comment);
            comments++;
        }
    ...
    public void set(String path, Object value, String[] comment) {
        for (final String comm : comment) {
            if (!this.config.contains(path)) {
                this.config.set(Main.manager.getPluginName() + "_COMMENT_" + comments, " " + comm);
                comments++;
            }
        }
        this.config.set(path, value);
    ...
    public void setHeader(String[] header) {
        Main.manager.setHeader(this.file, header);
    ...
    public void saveConfig() {
        Main.manager.saveConfig(config.saveToString(), this.file);
    }
