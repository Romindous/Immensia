...
public class Resolver {
    ...
    public static BVec position(final CommandContext<CommandSourceStack> cntx, final String name) throws CommandSyntaxException {
        final BlockPosition bp = cntx.getArgument(name, BlockPositionResolver.class).resolve(cntx.getSource());
        return BVec.of(bp.blockX(), bp.blockY(), bp.blockZ());
    }
