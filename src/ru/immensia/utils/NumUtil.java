...
//	}
    ...
    public static BVec rndCircPos(final BVec pos, final int dst) {
        final float aa = Main.srnd.nextFloat() - 0.5f,
            bb = Main.srnd.nextFloat() - 0.5f, a2 = aa * aa, b2 = bb * bb;
    ...
    public static Vector rndCircPos(final Vector loc, final int dst) {
        final double aa = Main.srnd.nextDouble() - 0.5d,
            bb = Main.srnd.nextDouble() - 0.5d, a2 = aa * aa, b2 = bb * bb;
    ...
    public static int randInt(final int num1, final int num2) {
      ...
      return Math.min(num1, num2) + Main.srnd.nextInt(abs(num2 - num1));
    }

    public static boolean rndBool() {
      return Main.srnd.nextBoolean();
    }

    public static int rndSignNum(int init, final int rnd) {
      if (rnd > 0) init += Main.srnd.nextInt(rnd + 1);
      return randSign() * init;
    }

    public static int randSign() {
        return (Main.srnd.nextInt(2) - 1) | 1;
    }
