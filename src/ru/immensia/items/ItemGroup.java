...
public abstract class ItemGroup implements Keyed {
    ...
    public static final NamespacedKey KEY = IStrap.key("mat");
...
//        irc.set(key().value(), Arrays.stream(its).map(it -> ItemUtil.write(it)).toList()); TODO
        irc.saveConfig();
